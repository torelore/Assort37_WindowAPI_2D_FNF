...
void CCharacter::MoveUp(float DeltaTime)
{
}

void CCharacter::MoveDown(float DeltaTime)
{
}

void CCharacter::MoveLeft(float DeltaTime)
{
}

void CCharacter::MoveRight(float DeltaTime)
{
}
