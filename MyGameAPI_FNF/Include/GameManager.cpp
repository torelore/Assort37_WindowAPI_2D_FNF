...
#include "Scene/Scene/Scene_Start.h"
#include "Input.h"
...
bool CGameManager::Init(HINSTANCE hInst)
{
	...
	CSceneManager::GetInst()->CreateScene<CScene_Start>();
...
BOOL CGameManager::Create()
{
	...
	//SetWindowPos(m_hWnd, HWND_TOPMOST, 1920, 100, rc.right - rc.left,		rc.bottom - rc.top,		SWP_NOZORDER);
	SetWindowPos(m_hWnd, HWND_TOPMOST, 0, 0, rc.right,		rc.bottom,		SWP_NOZORDER);
